...
CircularBar circload(240, 160, 0);
...
void loop(){
    // ------- ESCRITO MANUAL
    circload.setValue(analogRead(potPin)); //Use this command to change widget value.
    // circload.setValue() criado automaticamente, analogRead(potPin) foi inserido manualmente
    // ------- FIM
    delay(2000);
}
