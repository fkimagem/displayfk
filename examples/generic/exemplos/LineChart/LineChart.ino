...
void loop(){
    // ------- ESCRITO MANUAL
    linechart.push(0, analogRead(potPin)); //Use this line to add value in serie 0.
    // linechart.push() criado automaticamente, apenas argumento analogRead(potPin) foi inserido manualmente
    // ------- FIM
    linechart.push(1, random(0, 4095)); //Use this line to add value in serie 1.
    delay(2000);
}
