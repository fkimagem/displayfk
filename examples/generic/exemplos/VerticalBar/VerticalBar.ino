...
void loop(){
    // ------- ESCRITO MANUAL
    vertbar.setValue(analogRead(potPin)); //Use this command to change widget value.
    // vertbar.setValue() criado automaticamente, analogRead(potPin) foi inserido manualmente
    // ------- FIM
    delay(2000);
}
