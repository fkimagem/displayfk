...
void loop(){
    // ------- ESCRITO MANUAL
    vertalog.setValue(analogRead(potPin), true); //Use this command to change widget value.
    // vertalog.setValue() criado automaticamente, apenas argumento analogRead(potPin) foi inserido
    // ------- FIM
    delay(2000);
}
