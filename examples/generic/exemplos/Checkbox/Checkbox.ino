...
CheckBox checkbox(225, 150, 0);
const uint8_t qtdCheckbox = 1;
CheckBox *arrayCheckbox[qtdCheckbox] = {&checkbox};
bool check0_val = false; // Global variable that stores the value of the widget checkbox
// ------- ESCRITO MANUAL
int pinLed = 16;
// ------- FIM
...
void checkbox_cb(){
    check0_val = checkbox.getStatus();
    // ------- ESCRITO MANUAL
    digitalWrite(pinLed, check0_val );
    // ------- FIM
}