...
void setup(){
    ...
    myDisplay.startTouchXPT2046(DISPLAY_W, DISPLAY_H, rotationScreen, TOUCH_CS, &spi_shared, tft, TOUCH_FREQUENCY, DISP_FREQUENCY, DISP_CS);
...
void screen0(){
    ...
    tft->fillCircle(265, 119, 15, CFK_COLOR01);
    tft->drawCircle(265, 119, 15, CFK_BLACK);
    tft->fillCircle(217, 133, 15, CFK_COLOR11);
    tft->drawCircle(217, 133, 15, CFK_BLACK);
    tft->fillCircle(217, 105, 15, CFK_COLOR21);
    tft->drawCircle(217, 105, 15, CFK_BLACK);
    tft->fillCircle(249, 133, 10, CFK_COLOR06);
    tft->drawCircle(249, 133, 10, CFK_BLACK);
    tft->fillCircle(201, 119, 10, CFK_COLOR17);
    tft->drawCircle(201, 119, 10, CFK_BLACK);
    tft->fillCircle(248, 105, 10, CFK_COLOR28);
    tft->drawCircle(248, 105, 10, CFK_BLACK);
