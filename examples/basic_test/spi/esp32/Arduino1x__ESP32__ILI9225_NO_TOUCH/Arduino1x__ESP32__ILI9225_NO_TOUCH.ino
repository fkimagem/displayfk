...
void screen0(){
    ...
    tft->fillCircle(47, 39, 15, CFK_COLOR01);
    tft->drawCircle(47, 39, 15, CFK_BLACK);
    tft->fillCircle(23, 53, 15, CFK_COLOR11);
    tft->drawCircle(23, 53, 15, CFK_BLACK);
    tft->fillCircle(23, 25, 15, CFK_COLOR21);
    tft->drawCircle(23, 25, 15, CFK_BLACK);
    tft->fillCircle(39, 53, 10, CFK_COLOR06);
    tft->drawCircle(39, 53, 10, CFK_BLACK);
    tft->fillCircle(15, 39, 10, CFK_COLOR17);
    tft->drawCircle(15, 39, 10, CFK_BLACK);
    tft->fillCircle(39, 25, 10, CFK_COLOR28);
    tft->drawCircle(39, 25, 10, CFK_BLACK);
    myDisplay.printText("Custom text", 45, 72, TL_DATUM, CFK_BLACK, CFK_WHITE, &RobotoRegular10pt7b);
