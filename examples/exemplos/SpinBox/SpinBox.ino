...
SpinBox spinbox(150, 120, 0);
const uint8_t qtdSpinbox = 1;
SpinBox *arraySpinbox[qtdSpinbox] = {&spinbox};
int spin0_val = 0; // Global variable that stores the value of the widget spinbox
// ------- ESCRITO MANUAL
int ledPin = 16;
// ------- FIM
...
void loop(){
    // Use the variable spin0_val to check value/status of widget spinbox
    delay(2000);
}
