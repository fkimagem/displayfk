...
const int DISP_SDA = 21;
const int DISP_SCL = 22;
...
void screen0(){
    ...
    tft->drawCircle(16, 13, 11, CFK_COLOR01);
    myDisplay.printText("Custom text", 35, 6, TL_DATUM, CFK_COLOR01, CFK_WHITE, &RobotoRegular5pt7b);
    tft->display();
