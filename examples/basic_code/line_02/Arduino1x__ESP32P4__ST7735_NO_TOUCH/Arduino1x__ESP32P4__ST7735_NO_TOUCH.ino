...
void setup(){
    ...
    tft = new Arduino_ST7735(bus, DISP_RST, rotationScreen, isIPS);
...
void screen0(){
    ...
    myDisplay.printText("Custom text", 10, 72, TL_DATUM, CFK_BLACK, CFK_WHITE, &RobotoRegular10pt7b);
    tft->fillCircle(48, 35, 15, CFK_COLOR01);
    tft->drawCircle(48, 35, 15, CFK_BLACK);
    tft->fillCircle(24, 48, 15, CFK_COLOR11);
    tft->drawCircle(24, 48, 15, CFK_BLACK);
    tft->fillCircle(23, 21, 15, CFK_COLOR21);
    tft->drawCircle(23, 21, 15, CFK_BLACK);
    tft->fillCircle(40, 48, 10, CFK_COLOR06);
    tft->drawCircle(40, 48, 10, CFK_BLACK);
    tft->fillCircle(16, 35, 10, CFK_COLOR17);
    tft->drawCircle(16, 35, 10, CFK_BLACK);
    tft->fillCircle(39, 21, 10, CFK_COLOR28);
    tft->drawCircle(39, 21, 10, CFK_BLACK);
