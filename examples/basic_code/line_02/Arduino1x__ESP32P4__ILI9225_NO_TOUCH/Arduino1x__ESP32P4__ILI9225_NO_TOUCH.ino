...
void setup(){
    ...
    tft = new Arduino_ILI9225(bus, DISP_RST);
    tft->begin(DISP_FREQUENCY);
    tft->setRotation(rotationScreen);
...
void screen0(){
    ...
    myDisplay.printText("Custom text", 50, 82, TL_DATUM, CFK_BLACK, CFK_WHITE, &RobotoRegular10pt7b);
    tft->fillCircle(52, 46, 15, CFK_COLOR01);
    tft->drawCircle(52, 46, 15, CFK_BLACK);
    tft->fillCircle(28, 59, 15, CFK_COLOR11);
    tft->drawCircle(28, 59, 15, CFK_BLACK);
    tft->fillCircle(27, 32, 15, CFK_COLOR21);
    tft->drawCircle(27, 32, 15, CFK_BLACK);
    tft->fillCircle(44, 59, 10, CFK_COLOR06);
    tft->drawCircle(44, 59, 10, CFK_BLACK);
    tft->fillCircle(20, 46, 10, CFK_COLOR17);
    tft->drawCircle(20, 46, 10, CFK_BLACK);
    tft->fillCircle(43, 32, 10, CFK_COLOR28);
    tft->drawCircle(43, 32, 10, CFK_BLACK);
