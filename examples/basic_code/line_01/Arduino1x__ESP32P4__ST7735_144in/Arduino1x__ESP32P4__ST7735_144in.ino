...
void screen0(){
    ...
    tft->fillCircle(50, 54, 15, CFK_COLOR01);
    tft->drawCircle(50, 54, 15, CFK_BLACK);
    tft->fillCircle(44, 59, 15, CFK_COLOR11);
    tft->drawCircle(44, 59, 15, CFK_BLACK);
    tft->fillCircle(44, 48, 15, CFK_COLOR21);
    tft->drawCircle(44, 48, 15, CFK_BLACK);
    tft->fillCircle(48, 59, 10, CFK_COLOR06);
    tft->drawCircle(48, 59, 10, CFK_BLACK);
    tft->fillCircle(42, 54, 10, CFK_COLOR17);
    tft->drawCircle(42, 54, 10, CFK_BLACK);
    tft->fillCircle(48, 48, 10, CFK_COLOR28);
    tft->drawCircle(48, 48, 10, CFK_BLACK);
