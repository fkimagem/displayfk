...
const uint16_t CFK_COLOR_004 = process_color(0x7AAA);   // #7F5555
const uint16_t CFK_COLOR_005 = process_color(0xFD55);   // #FFAAAA
const uint16_t CFK_COLOR_006 = process_color(0x7945);   // #7F2A2A
const uint16_t CFK_COLOR_007 = process_color(0xFAAA);   // #FF5555
const uint16_t CFK_COLOR_008 = process_color(0x7800);   // #7F0000
const uint16_t CFK_COLOR_009 = process_color(0xF800);   // #FF0000
const uint16_t CFK_COLOR_010 = process_color(0x7B4A);   // #7F6A55
const uint16_t CFK_COLOR_011 = process_color(0xFEB5);   // #FFD4AA
const uint16_t CFK_COLOR_012 = process_color(0x7AA5);   // #7F552A
const uint16_t CFK_COLOR_013 = process_color(0xFD4A);   // #FFAA55
const uint16_t CFK_COLOR_014 = process_color(0x79E0);   // #7F3F00
const uint16_t CFK_COLOR_015 = process_color(0xFBE0);   // #FF7F00
const uint16_t CFK_COLOR_016 = process_color(0x7BEA);   // #7F7F55
const uint16_t CFK_COLOR_017 = process_color(0xFFF5);   // #FFFFAA
const uint16_t CFK_COLOR_018 = process_color(0x7BE5);   // #7F7F2A
const uint16_t CFK_COLOR_019 = process_color(0xFFEA);   // #FFFF55
const uint16_t CFK_COLOR_020 = process_color(0x7BE0);   // #7F7F00
const uint16_t CFK_COLOR_021 = process_color(0xFFE0);   // #FFFF00
const uint16_t CFK_COLOR_022 = process_color(0x6BEA);   // #6A7F55
const uint16_t CFK_COLOR_023 = process_color(0xD7F5);   // #D4FFAA
const uint16_t CFK_COLOR_024 = process_color(0x53E5);   // #557F2A
const uint16_t CFK_COLOR_025 = process_color(0xAFEA);   // #AAFF55
const uint16_t CFK_COLOR_026 = process_color(0x3BE0);   // #3F7F00
const uint16_t CFK_COLOR_027 = process_color(0x7FE0);   // #7FFF00
const uint16_t CFK_COLOR_028 = process_color(0x53EA);   // #557F55
const uint16_t CFK_COLOR_029 = process_color(0xAFF5);   // #AAFFAA
const uint16_t CFK_COLOR_030 = process_color(0x2BE5);   // #2A7F2A
const uint16_t CFK_COLOR_031 = process_color(0x57EA);   // #55FF55
const uint16_t CFK_COLOR_032 = process_color(0x03E0);   // #007F00
const uint16_t CFK_COLOR_033 = process_color(0x07E0);   // #00FF00
const uint16_t CFK_COLOR_034 = process_color(0x53ED);   // #557F6A
const uint16_t CFK_COLOR_035 = process_color(0xAFFA);   // #AAFFD4
const uint16_t CFK_COLOR_036 = process_color(0x2BEA);   // #2A7F55
const uint16_t CFK_COLOR_037 = process_color(0x57F5);   // #55FFAA
const uint16_t CFK_COLOR_038 = process_color(0x03E7);   // #007F3F
const uint16_t CFK_COLOR_039 = process_color(0x07EF);   // #00FF7F
const uint16_t CFK_COLOR_040 = process_color(0x53EF);   // #557F7F
const uint16_t CFK_COLOR_041 = process_color(0xAFFF);   // #AAFFFF
const uint16_t CFK_COLOR_042 = process_color(0x2BEF);   // #2A7F7F
const uint16_t CFK_COLOR_043 = process_color(0x57FF);   // #55FFFF
const uint16_t CFK_COLOR_044 = process_color(0x03EF);   // #007F7F
const uint16_t CFK_COLOR_045 = process_color(0x07FF);   // #00FFFF
const uint16_t CFK_COLOR_046 = process_color(0x534F);   // #556A7F
const uint16_t CFK_COLOR_047 = process_color(0xAEBF);   // #AAD4FF
const uint16_t CFK_COLOR_048 = process_color(0x2AAF);   // #2A557F
const uint16_t CFK_COLOR_049 = process_color(0x555F);   // #55AAFF
const uint16_t CFK_COLOR_050 = process_color(0x01EF);   // #003F7F
const uint16_t CFK_COLOR_051 = process_color(0x03FF);   // #007FFF
const uint16_t CFK_COLOR_052 = process_color(0x52AF);   // #55557F
const uint16_t CFK_COLOR_053 = process_color(0xAD5F);   // #AAAAFF
const uint16_t CFK_COLOR_054 = process_color(0x294F);   // #2A2A7F
const uint16_t CFK_COLOR_055 = process_color(0x52BF);   // #5555FF
const uint16_t CFK_COLOR_056 = process_color(0x000F);   // #00007F
const uint16_t CFK_COLOR_057 = process_color(0x001F);   // #0000FF
const uint16_t CFK_COLOR_058 = process_color(0x6AAF);   // #6A557F
const uint16_t CFK_COLOR_059 = process_color(0xD55F);   // #D4AAFF
const uint16_t CFK_COLOR_060 = process_color(0x514F);   // #552A7F
const uint16_t CFK_COLOR_061 = process_color(0xAABF);   // #AA55FF
const uint16_t CFK_COLOR_062 = process_color(0x380F);   // #3F007F
const uint16_t CFK_COLOR_063 = process_color(0x781F);   // #7F00FF
const uint16_t CFK_COLOR_064 = process_color(0x7AAF);   // #7F557F
const uint16_t CFK_COLOR_065 = process_color(0xFD5F);   // #FFAAFF
const uint16_t CFK_COLOR_066 = process_color(0x794F);   // #7F2A7F
const uint16_t CFK_COLOR_067 = process_color(0xFABF);   // #FF55FF
const uint16_t CFK_COLOR_068 = process_color(0x780F);   // #7F007F
const uint16_t CFK_COLOR_069 = process_color(0xF81F);   // #FF00FF
const uint16_t CFK_COLOR_070 = process_color(0x7AAD);   // #7F556A
const uint16_t CFK_COLOR_071 = process_color(0xFD5A);   // #FFAAD4
const uint16_t CFK_COLOR_072 = process_color(0x794A);   // #7F2A55
const uint16_t CFK_COLOR_073 = process_color(0xFAB5);   // #FF55AA
const uint16_t CFK_COLOR_074 = process_color(0x7807);   // #7F003F
const uint16_t CFK_COLOR_075 = process_color(0xF80F);   // #FF007F
