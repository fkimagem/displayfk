 ...
 * This object replaces esp_cam_sensor_detect_get_array() and probes OV2710 only.
 */
...
#include "ov2710/ov2710.h"

static const char *TAG = "ov2710_hook";

static esp_cam_sensor_device_t *ov2710_detect_mipi(void *config)
{
